angular.module('rsc.service.trade_me_common', [])
    .factory('TradeMeUtils', ['$log', '$bottomSheet', '$ionicLoading', 'FileUpload', '$http', '$timeout', '$ionicActionSheet', '$rootScope', '$compile', '$ionicBody', 'fileReader', 'ENV', '$ionicPlatform', '$ionicHistory', 'iAlert',
