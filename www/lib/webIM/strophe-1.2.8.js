...
// Base64 code from Tyler Akins -- http://rumkin.com
     ...
     *  > };
        ...
        Strophe.Builder.prototype = {
             ...
             *  tree.  It is often used internally to src data to a
         ...
         *  and host part and just src the path, e.g.
         *
         ...
         *  ------------------------------------------
         *
         *  The "cookies" option allows you to src in cookies to be added to the
 ...
 *  }
        ...
        Strophe.Connection.prototype = {
             ...
             *    (String) src - The user's password.
     ...
     *  > };
             ...
             *  full JIDs. To use this, src {matchBare: true} as the value of
